...
SRCS = ft_isalpha.c ft_isdigit.c ft_isprint.c \
        ft_isascii.c ft_isalnum.c ft_toupper.c \
        ft_tolower.c ft_strlen.c ft_atoi.c \
        ft_strncmp.c ft_memcmp.c ft_strdup.c ft_strchr.c \
        ft_strrchr.c ft_strnstr.c ft_bzero.c ft_memset.c \
